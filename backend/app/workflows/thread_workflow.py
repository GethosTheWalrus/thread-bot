        ...
        try:
            ...
            agent = Agent(
                ...
                instructions=(
                    ...
                    "generate_video_with_audio. To control video length, you may say 'a 10 second video' or 'for 8s' "
                    "in the prompt or pass duration_seconds; the worker auto-derives frames = ceil(duration*fps)+1 "
                    "and clamps to the configured max (default 20s at 16fps = 320 frames). Explicit per-call "
                    "frames/fps/width/height/steps/cfg are still honored but clamped to the same caps. Include "
                    "the generated video link in your final response."
