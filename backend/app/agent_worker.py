...
from app.activities.autonomy_activities import (
    ...
    recheck_authorization, execute_authorized_action, persist_action_result, sync_agent_action_result,
